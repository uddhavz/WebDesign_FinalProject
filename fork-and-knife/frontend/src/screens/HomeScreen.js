    ...
    <>
      ...
      <div className="intro-section">
        <p className="intro-section-text">
          Fork and Knife is a culinary journey through the finest ingredients
            ...
            <Row className="mt-4 rowRow">
              <Col md={6}>
                <div className="press-links">
                  ...
                  <p>
                    ...
                    tradition with innovation, look no further than Fork &
                    Knife.
                  </p>
                </div>
              </Col>
              <Col md={6}>
                <div className="press-links">
                  ...
                  <p>
                    Our recent meal at Fork & Knife was nothing short of
